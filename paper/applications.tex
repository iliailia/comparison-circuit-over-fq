...
\label{sec:min/max}
	...
	Another application of our comparison algorithm is concerned with the minimum (or maximum) function.
	The minimum function requires at least $n-1$ pairwise minimums~\cite{CLR09}, which can be achieved by \emph{the tournament method}.
	\begin{figure}
		\centering
		\begin{tikzpicture}
			% first stage
