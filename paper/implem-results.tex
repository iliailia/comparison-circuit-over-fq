...
\todo{Compare to \cite{CDSS15}, TFHE-based and HEAAN-based solutions.}
\begin{table}[h]
  \centering
...
\begin{table}[h]
  ...
  \begin{tabular*}{.9\textwidth}{@{\extracolsep{\fill} } c c c c c}
    \toprule
    $N$     & $\log_2 q$    & \#Trials  & \makecell{Avg. total \\ time, s}    & \makecell{Amortized time \\ per slot, ms} \\
    \midrule
    \multicolumn{5}{l}{8-bit integers ($d=2$, $\ell=1$, $k=9352$)} \\
    \cmidrule(lr){1-5}
    4       & >580             & 32        & 186.28                & 19.92 \\
    8       & 599           & 20        & 867.46                & 92.76 \\
    16      & 599           & 20        & 3652.23               & 390.53 \\
    32      & 599           & 20        & 14769.23              & 1579.26 \\
    64      & >600             & 2         & 60665.9               & 6486.94 \\
    \midrule
    \multicolumn{5}{l}{32-bit integers ($d=3$, $\ell=2$, $k=4676$)} \\
    \cmidrule(lr){1-5}
    4       & >650             & 20        & 299.17                & 63.98 \\
    8       & >660             & 20        & 1356.19               & 290.03 \\
    16      & >660             & 20        & 5700.12               & 1219.02 \\
    32      & 684           & 13        & 23066.90              & 4933.04 \\
    64      & 684           & 1         & 89828.9               & 19210.6 \\
    \bottomrule
  \end{tabular*}
  \caption{The running time needed to sort $N$ 8-bit or 32-bit integers with $p=167$, $m=28057$ and $n=28056$. The minimal security level is 92 bits according to the LWE estimator~\cite{lwe_estimator}.}
...
\begin{table}[h]
  ...
  \begin{tabular*}{.9\textwidth}{@{\extracolsep{\fill} } c c c c c c}
    ...
    8       & 1     & 854           & 20        & 545.56    & 209.03 \\
    16      & 1     & 854           & 20        & 1786.80   & 684.60 \\
    32      & 1     & 854           & ??        & ????.??   & ????.?? \\
    64      & 1     & ???           & ??        & ?????.??  & ?????.?? \\
    \bottomrule
  \end{tabular*}
