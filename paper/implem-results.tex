...
\begin{figure}
    ...
    \begin{tikzpicture}
        \begin{axis}[
            ...
            xtick = {1,2,3,4,5,6},
            xticklabels = {3,5,7,11,13,17},
            ylabel = {Amortized time, ms},
            xlabel = {plaintext modulus $p$},
            ytick = \empty]
                \addplot[ybar, fill=white, bar width = 15pt, nodes near coords] coordinates {(1, 90) (2, 36) (3,71) (4,99) (5,54) (6,101)};
                \addplot[ybar, fill=gray, bar width = 10pt, nodes near coords] coordinates {(1, 70) (2, 21) (3,40) (4,64) (5,35) (6,70)};
                \addplot[ybar, fill=black, bar width = 5pt, nodes near coords] coordinates {(1, 56) (2, 21) (3,31) (4,35) (5,16) (6,27)};
                
            \end{axis}
    \end{tikzpicture}
    \caption{\textbf{Less-than function via different methods.} The amortized running time per 64-bit integer of our lexicographic order algorithms and the algorithm of Tan et al.~\cite{TLWRK20}. The data is taken from Table~\ref{table:comparison_circuit_results}.}
