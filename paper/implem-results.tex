...
For $p=131$, the univariate circuit takes only 11 milliseconds to compare two 64-bit integers (Table~\ref{table:univariate_circuit_results}), which is more than 3 times faster than the best running time achieved by the circuit of Tan et al.
