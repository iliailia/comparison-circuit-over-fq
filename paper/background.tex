...
Every function from $\F_{p^d}^l$ to $\F_{p^d}$ can be interpolated by a unique polynomial that can be defined with Lagrange interpolation and the help of the principal character. 
